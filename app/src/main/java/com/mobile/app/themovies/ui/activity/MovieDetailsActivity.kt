package com.mobile.app.themovies.ui.activity
...
import com.mobile.app.themovies.ui.widget.fromUrl
...
class MovieDetailsActivity: AppCompatActivity() {
    ...
    private val viewModel by lazy { ViewModelProviders.of(this, viewModelFactory).get(MovieDetailsActivityViewModel::class.java) }
